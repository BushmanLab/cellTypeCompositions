...
#+begin_src R
  ...
  res2 <- tuneScan(wtab$tab,wtab$data.index,om,res)
  plot(res$logLik)
...
#+begin_src cpp
  ...
  List sampleParms(
   ...
   // lambda>head_cols(lambdaM) = lambdaUpdate;

   return List::create(_["eta"] = etaTab,
		       _["lambda"] = lambdaUpdate);
  }
